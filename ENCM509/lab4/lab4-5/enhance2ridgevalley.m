function Fp = enhance2ridgevalley(Fp)

% ENHANCERIDGEVALLEY implement directional filtering (Gabor). 
% Number max of filters used : 48
% orientation range : [- pi/2 : pi/8 : pi/2]
