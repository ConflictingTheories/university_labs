...
BER = BE/M;
display('For Random Phase Error with Std. Dev. of 0*:');
display(BER);

%% Step 9 - Repeat Steps 3-8 For Different Values of AWGN Noise Variance
% For Random Phase Error of Std. Dev 10*

% For Random Phase Error of Std. Dev 20*

% For Random Phase Error of Std. Dev 30*