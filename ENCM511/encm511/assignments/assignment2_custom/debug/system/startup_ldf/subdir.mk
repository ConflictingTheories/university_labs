...
system/startup_ldf/%.doj: ../system/startup_ldf/%.s
	...
	easmblkfn.exe -file-attr ProjectName="Assignment2_Custom" -proc ADSP-BF533 -si-revision any -g -D_DEBUG -i"H:\ENCM511_2014Workspace\Assignment2_Custom\system" -gnu-style-dependencies -MM -Mo "$(basename $@).d" -o "$@" "$<"
	@echo 'Finished building: $<'
	@echo ' '
